...
public class UserController {
	...
	@Cacheable(value = "userEhCache") // 使用了一个缓存名叫 userCache
	...
	@CachePut(value = "userEhCache") // 使用了一个缓存名叫 userCache
	...
	// 删除全部缓存
	@CacheEvict(value="userEhCache",allEntries=true,beforeInvocation=true)
	...
	//　删除部分缓存
	@CacheEvict(value="userEhCache",beforeInvocation=true)
	...
	//　删除部分缓存
	@CacheEvict(value="userEhCache",key="#user_id",beforeInvocation=true)
